...
from explain.utils.display import grid_display, heatmap_display
from explain.utils.image import apply_grey_patch
from explain.utils.saver import save_rgb
...
class OcclusionSensitivity:
    ...
    def explain(
        ...
        Returns:
            np.ndarray: Grid of all the sensitivity maps with shape (batch_size, H, W, 3) or 4D array (batch_size, height, width, channels)
        """
